...
public class DragSortSimpleAdapter extends SimpleAdapter implements IDragSortAdapter {
    private int mPosition[];
    private int mHandler;
    private List<? extends Map<String, ?>> dataList;

    public DragSortSimpleAdapter(Context context, List<? extends Map<String, ?>> data, int resource, String[] from,
                                 int[] to, int handler) {
