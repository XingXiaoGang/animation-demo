...
public class DragSortListView extends ListView {
	...
	public void setDragSortAdapter(IDragSortAdapter adapter) {
	...
	private void startDrag(int childIndex, int y) {
        ...
        IDragSortAdapter dndAdapter;

        // if exists a footer/header we have our adapter wrapped
        if (adapter instanceof WrapperListAdapter) {
            dndAdapter = (IDragSortAdapter)((WrapperListAdapter)adapter).getWrappedAdapter();
        } else {
            dndAdapter = (IDragSortAdapter)adapter;
        }
