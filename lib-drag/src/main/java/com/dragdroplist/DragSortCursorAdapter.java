...
public class DragSortCursorAdapter extends SimpleCursorAdapter implements IDragSortAdapter {
    int mPosition[];
    int mHandler;

    public DragSortCursorAdapter(Context context, int layout, Cursor cursor, String[] from, int[] to, int handler) {
    ...
    @Override
    public void onItemDrag(DragSortListView parent, View view, int position, long id) {

    }

    @Override
    public void onItemDrop(DragSortListView parent, View view, int startPosition, int endPosition, long id) {
