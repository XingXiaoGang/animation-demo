...
public class DragSortListView extends ListView {
    ...
    public void setAdapter(ListAdapter adapter) {
        if (adapter != null) {
            mAdapterWrapper = new DragSortAdapterWrapper(this, adapter);
     ...
     * wrapped item.
     */
    protected void adjustItem(int position, View v, boolean invalidChildHeight) {
        // Adjust item height
        ...
        if (position == mFirstExpPos || position == mSecondExpPos) {
            if (position < mSrcPos) {
                ((DragSortItemWrapperView) v).setGravity(Gravity.BOTTOM);
            } else if (position > mSrcPos) {
                ((DragSortItemWrapperView) v).setGravity(Gravity.TOP);
            }
        }
